...
>Bob wants to learn how to fly in a flight simulator. He is instructed by Henry. Unknown to Bob, Henry is a malicious impostor who has inserted a randomizing device in the simulator’s controls and intends to give all kinds of incorrect advice. Fortunately, by sheer chance the randomizing device causes exactly the same results in the simulator as would have occurred without it, and by incompetence Henry gives exactly the same advice as a proper instructor would have done. Bob passes the course with flying colors. He has still not flown a real plane. Bob has a justified true belief about how to fly.
>
>(2001 p. 435)

Bob at this point only has a reasonably justified true belief. It is only *after* Bob has successfully flown a plane independent of the teaching process, that we can say that he has true/real knowledge of how to fly a plane. Before that, objectively, it’s only an untested propositional possibility. It’s the action of actually piloting that illuminates the knowledge known, and distinguishes between a true and a false proposition. It is only once a JTB scenario is tested and not disqualified by the test, can it be known as knowledge, albeit a provisional type. Before that test it can only be thought of as a *reasonably* justified true belief.

In other words, we can view a pre-test JTB as similar to a pre-test scientific hypothesis. Essentially, the analysis of knowledge is an argument, and like all arguments to know its soundness and its validity we must measure it objectively. Essentially this is a soft-scepticism approach to the problem; knowledge is at best provisional. In this sense, Gettier cases would still hold that JTB fails in accounting for knowledge, but that by adding a fourth clause provisional-truth could be ascertained.

For instance, let’s look at Bertrand Russell’s well known example of the stopped clock:
...
Metaphysically, knowledge seems beyond our reach as justification for true beliefs are reliant on too many levels of contingent organisation. If we take a Humean perspective of the internal and external metaphysics at play, we can easily see these levels of organisation overwhelmingly building up on us. David Hume operated under the distinction that there are two distinct ways we can think between, internally represented as a relationship of ideas (ROI), or externally as cases of matters of fact (MOF).

Within this first internal perspective (ROI) we can see that our beliefs rely on other beliefs, and that this reliance isn’t always homogeneous; beliefs can conflict with each other and large gaps of ignorance can exist between them. Moreover, these beliefs operate atop an underlying framework of presuppositions and apparent self-evident axioms; all of which are further reliant on the internal language of the mind, seemingly consisting of non-commutable symbols, words, and intuitions. On the other hand, the external world (MOF) is in large part beyond our metaphysical reach, both in size and time, and also by the limits of our observational stance; the human senses only being able to see a tiny slither of space and time of this immense and old external world.

Not to mention that any justification that isn’t reliant on luck or intuition must be based on some logical ground, and that logic itself when pushed lacks complete internal consistency; which Kurt Gödel (1931) devastatingly exposed in his incompleteness theorems.  This means that the space we seemingly know the best, the internal world of our own mind, is justificationally just as limited to us as the external world is metaphysically. Worse still, these problems of justification don’t appear to be going anywhere; they appear to be fundamental.

One way we can think of this arena of knowledge is like a deep dark ocean. Where we can dive down into it holding our breath and investigate for a while, but eventually are forced to resurface for lack of air. Like the water of the ocean, we too can dive into knowledge by testing what we think on justifiable grounds internally, and likewise we can’t stay there indefinitely as we lack the means to test every possible proposition in constancy. But the good news is that we don’t necessarily need any other type of knowledge beyond this momentary type. As David Hume also points out, sometimes it’s *rational to be irrational* when it comes to what we do and do not know in an operational-sense.

There are many things that we aren’t absolutely sure of, but at the same time we are aware of the futility in seeking genuine knowledge regarding these cases. For instance, when we look out our window on to the street outside and see people outside we can’t be absolutely certain that they are in fact actually people and not robots disguised to look like ordinary people. While technically possible, the value and the effort needed to constantly test this scenario is reasonably unjustified on the grounds of probability and futility. It is probabilistically unlikely that this would be the case, and it’s an action of futility to forever test. As Hume rightly pointed out, there are limits to what we are capable of knowing and as such need to base our inquiries to those matters of that best fit our ability to know, and best fit our need to now. In this case, it is of low importance considering the contingent facts and beliefs that form the belief that people there exist, and the low risk associated if they were not who they appeared to be.
