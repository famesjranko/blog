...
In general, anyone asked to define philosophy is going to struggle and increasingly so the more they tend toward profundity.  The more profound one aims the greater the chance of ending up with a ‘deepity’ – a term coined by Daniel Dennett that refers to a statement that superficially appears to express a deep profound truth, but is in actuality nothing but aesthetic nonsense. Moreover, both terms are too qualified and limiting for a proper definition for what philosophy is.

If we define something as (A), anything that conforms to (A) therefore must be (A).  In this sense, if we define philosophy as ‘knowing or caring for oneself’ anything that conforms to it must therefore be considered philosophy.  This even on first viewing seems incredible and unlikely.  Philosophy is both more limited by its methods and greater in its scope than this definition would allow.  For example, what does it mean to know?  If I look in the mirror and examine my facial features, hair length and colour, recognising that my features are, to a lesser or greater degree, unique, does this qualify as ‘knowing myself’ and therefore philosophy?  Surely this can’t be the case.  Philosophical knowledge must be more than just a kind of recognition.
...
>But if there was nothing, how could anything have got started?  Where could it have come from?  Time couldn’t just suddenly pop into existence–bingo!–out of nothing, and start going, all by itself.  Nothing is nothing, not anything.  So the idea of a beginning was unimaginable, which somehow made it seem impossible too.  The upshot was that it seemed impossible for time to have had a beginning and impossible for it not to have had a beginning.”
>
>(Magee 1997, pp. 4-5)
