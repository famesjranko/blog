...
2. Data is aggregated and anonymised as per Google Maps guidelines/methods (Google, 2020b).
    a. Data is harvested from users, only where privacy settings allow for data collection – opt-in, off by default.
    b. User data is only used where the privacy threshold is met – must be enough users at a location to ensure anonymity.
    c. Use of differential privacy, which adds artificial noise to data to further prevent identification of any individual person.
...
1. Construct the hypothetical imperative into the form of a maxim:
    a. In circumstances x, I am to y, in order to z.
2. Generalise the maxim into the form:
    a. In circumstances x, everyone is to y, in order to z.
3. Generalise the precept at 2a into the form of a law of nature:
    a. In circumstances x, everyone always is to y, in order to z.
4. Apply the law of nature at 3a to the actual world state and figure out the implications to the world if this law of nature were universal and allowed to reach equilibrium.

Additionally, there are two tests that aid us at step 4:

- **t1. “The Contradiction in Conception Test”** (California State University, 2020) – tests if the universalised maxim is still a viable means to the end.
- **t2. “The Contradiction in the Will Test”** (California State University, 2020) – tests if the will of a person conflicts with the maxim’s implications.

Following these steps and applying the substitutions:

- x = public health crisis
- y = sacrifice my privacy
- z = save the lives of others

1a. In circumstances of public health crisis, I am to sacrifice my privacy, in order to save the lives of others.

2a. In circumstances of public health crisis, everyone is to sacrifice their privacy, in order to save the lives of others.

3a. In circumstances of public health crisis, everyone always is to sacrifice their privacy, in order to save the lives of others.
...
1. **Options**
    a. Allow users’ data to be used by governing bodies
    b. Do not allow users’ data to be used by governing bodies
2. **Consequences**
    - 1a. (i) User data is used against the pandemic and it helps; (ii) user data is used to control/monitor citizens
    - 1b. (i) User data is not used against the pandemic, pandemic continues longer than needed; (ii) user data is not used to control/monitor citizens
3. **Probability and utility** (steps 3 & 4)
    - 1a. (i) Probability: Very High; Utility: Very High. (ii) Probability: High; Utility: Very Low
    - 1b. (i) Probability: Medium; Utility: Low. (ii) Probability: Low; Utility: Very High
...
Driver, Julia. (2014). The History of Utilitarianism. Retrieved from https://plato.stanford.edu/archives/win2014/entries/utilitarianism-history/
...
Google. (2020a). COVID-19 Community Mobility Report: Australia, March 29, 2020. Retrieved from https://www.google.com/covid19/mobility/

Google. (2020b). Privacy & Terms. Retrieved from https://policies.google.com/technologies/anonymization?hl=en

Hospers, J. (1972). Human Conduct: Problems of Ethics. New York: Harcourt Brace Jovanovich.

Johnson, Robert & Cureton, Adam. (2019). Kant’s Moral Philosophy. Retrieved from https://plato.stanford.edu/archives/spr2019/entries/kant-moral/

Kant, I. (2008). Groundwork for the Metaphysic of Morals. Retrieved from https://www.earlymoderntexts.com/assets/pdfs/kant1785.pdf

Rachels, J., Rachel, T. (1986). The Elements of Moral Philosophy. NY: McGraw Hill.

The Verge. (2020, April 3). Google uses location data to show which places are complying with stay-at-home orders — and which aren’t. Retrieved from https://www.theverge.com/2020/4/3/21206318/google-location-data-mobility-reports-covid-19-privacy

United Nations. (2020). Universal Declaration of Human Rights. Retrieved from https://archives.un.org/sites/archives.un.org/files/UDHR/udhr.pdf